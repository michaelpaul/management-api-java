...
public class UsersCompanyLevelApi {
    ...
    private okhttp3.Call getCompaniesCompanyIdUsersValidateBeforeCall(String companyId, Integer pageNumber, Integer pageSize, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getCompaniesCompanyIdUsersCall(companyId, pageNumber, pageSize, _callback);
        return localVarCall;
     ...
     */
    public ListCompanyUsersResponse getCompaniesCompanyIdUsers(String companyId, Integer pageNumber, Integer pageSize) throws ApiException {
        ApiResponse<ListCompanyUsersResponse> localVarResp = getCompaniesCompanyIdUsersWithHttpInfo(companyId, pageNumber, pageSize);
     ...
     */
    public ApiResponse<ListCompanyUsersResponse> getCompaniesCompanyIdUsersWithHttpInfo(String companyId, Integer pageNumber, Integer pageSize) throws ApiException {
        okhttp3.Call localVarCall = getCompaniesCompanyIdUsersValidateBeforeCall(companyId, pageNumber, pageSize, null);
     ...
     */
    public okhttp3.Call getCompaniesCompanyIdUsersAsync(String companyId, Integer pageNumber, Integer pageSize, final ApiCallback<ListCompanyUsersResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getCompaniesCompanyIdUsersValidateBeforeCall(companyId, pageNumber, pageSize, _callback);
        Type localVarReturnType = new TypeToken<ListCompanyUsersResponse>(){}.getType();
    ...
    private okhttp3.Call getCompaniesCompanyIdUsersUserIdValidateBeforeCall(String companyId, String userId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getCompaniesCompanyIdUsersUserIdCall(companyId, userId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call patchCompaniesCompanyIdUsersUserIdValidateBeforeCall(String companyId, String userId, UpdateCompanyUserRequest updateCompanyUserRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchCompaniesCompanyIdUsersUserIdCall(companyId, userId, updateCompanyUserRequest, _callback);
        return localVarCall;
    ...
    private okhttp3.Call postCompaniesCompanyIdUsersValidateBeforeCall(String companyId, CreateCompanyUserRequest createCompanyUserRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = postCompaniesCompanyIdUsersCall(companyId, createCompanyUserRequest, _callback);
        return localVarCall;
